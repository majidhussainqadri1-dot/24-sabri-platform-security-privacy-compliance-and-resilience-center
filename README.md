...
- Completeness/cross-plan correction regressions: **Cycles 278–280**
...
The corrected tree contains at least **294 PHP source/test files** and **206 independent top-level PHP test programs** under the exact-head CI gate. PHP 8.0/8.3 GitHub Actions remains the merge gate. Staging/live/operational claims remain separate.
