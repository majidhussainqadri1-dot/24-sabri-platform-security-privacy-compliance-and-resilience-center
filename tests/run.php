...
expect(Schema::VERSION === '0.25.3' && count(Schema::tables()) === 7, 'Corrective schema must expose seven owned tables.');
...
expect(is_array($repairResult) && get_option('spcrc_schema_version') === '0.25.3', 'Non-destructive repair must verify schema and record version.');
