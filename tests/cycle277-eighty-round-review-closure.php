...
c277(str_contains($register, 'Defect-bearing requested rounds | **9**'), 'Review register must preserve the corrected nine-defect final count.');
c277(str_contains($register, 'Clean requested rounds after those fixes | **71**'), 'Review register must preserve the corrected seventy-one clean-round count.');
