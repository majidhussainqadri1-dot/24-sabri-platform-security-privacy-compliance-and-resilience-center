...
c100(($status['version'] ?? '') === '0.99.0' && ! empty($status['repository_coding_complete']), 'Release status must identify three-plan repository code completion.');
...
$requiredDocs = [
    ...
    'THREE-PLAN-HARMONIZATION-0.99.0.md', 'CHAT-DIRECTIVES-TRACEABILITY-0.99.0.md',
    'FILES-00-26-INTEGRATION-MATRIX-0.99.0.md', 'REVIEW-AND-CORRECTION-ALL-CHATS-ROUND-1.md',
    'REVIEW-AND-CORRECTION-ALL-CHATS-ROUND-2.md',
];
foreach ($requiredDocs as $doc) c100(is_file($root . '/docs/' . $doc), 'Required repository document missing: ' . $doc);
$manuals = ['ADMINISTRATOR-MANUAL.md','PRIVACY-OFFICER-MANUAL.md','INCIDENT-COMMANDER-MANUAL.md','BACKUP-OPERATOR-MANUAL.md','DEVELOPER-SECURITY-GUIDE.md','TRUST-CENTER-GUIDANCE.md','SCHEMA-MANIFEST.json','SOURCE-MANIFEST.json','SECURITY-ARCHITECTURE.md','DATA-FLOW-OWNERSHIP.md','CONTROL-CATALOG.md','MODULE-SECURITY-SDK.md','API-EVENT-CONTRACTS.md','COMPLIANCE-APPLICABILITY.md','INCIDENT-RESPONSE-PLAN.md','DISASTER-RECOVERY-PLAN.md','BACKUP-RESTORE-GUIDE.md','KEY-GOVERNANCE-GUIDE.md','THREE-PLAN-HARMONIZATION.md','CHAT-DIRECTIVES-TRACEABILITY.md'];
...
c100(str_contains($ci, 'ChatDirectiveCatalog::count()') && str_contains($ci, 'PlatformIntegrationMatrix::all()) !== 27'), 'CI must verify the All-Chats directive catalogue and Files 00–26 matrix.');
