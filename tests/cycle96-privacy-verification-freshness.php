...
cycleReviewAssert(str_contains($plugin, 'Version:     0.28.0') && str_contains($plugin, "define('SPCRC_VERSION', '0.28.0')"), 'Final runtime identity must be 0.28.0.');
cycleReviewAssert(str_contains($readme, 'Stable tag: 0.28.0'), 'WordPress stable tag must match 0.28.0.');
cycleReviewAssert(is_file($root . '/docs/FORTY-ROUND-REVIEW-SUMMARY-0.28.0.md'), 'Forty-round summary must exist.');
cycleReviewAssert(is_file($root . '/docs/RELEASE-RECEIPT-0.28.0.md'), 'Release receipt must exist.');
cycleReviewAssert(is_file($root . '/docs/KNOWN-LIMITATIONS-0.28.0.md'), 'Truthful limitations must exist.');
cycleReviewAssert(is_file($root . '/docs/REQUIREMENTS-TRACEABILITY-0.28.0.md'), 'Requirements traceability must exist.');
