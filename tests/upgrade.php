...
namespace Sabri\Platform\Security {
    ...
    expectUpgrade(get_option('spcrc_version', '') === '0.28.0' && get_option('spcrc_schema_version', '') === '0.25.5', 'Corrective release must advance plugin and schema versions.');
