...
final class PlatformIntegrationMatrix
{
    ...
    private const FILES = [
        ...
        7 => ['file' => 7, 'name' => 'Doctors Directory', 'native_owner' => 'verified doctor discovery', 'assurance' => 'impersonation, scraping and contact safety', 'contract_filter' => 'spcrc/file07_contract_state', 'criticality' => 'optional', 'degraded_behavior' => 'directory assurance unavailable'],
        ...
        12 => ['file' => 12, 'name' => 'PDF Library', 'native_owner' => 'restricted PDF objects and reader access', 'assurance' => 'private delivery, entitlement and purge assurance', 'contract_filter' => 'spcrc/file12_contract_state', 'criticality' => 'high-risk', 'degraded_behavior' => 'restricted delivery gated'],
        13 => ['file' => 13, 'name' => 'Welcome Intro', 'native_owner' => 'session-aware accessible intro', 'assurance' => 'privacy, accessibility and route-suppression assurance', 'contract_filter' => 'spcrc/file13_contract_state', 'criticality' => 'optional', 'degraded_behavior' => 'intro assurance unavailable'],
        ...
        16 => ['file' => 16, 'name' => 'Sabri Classical Homeopathy AI', 'native_owner' => 'source-linked educational AI', 'assurance' => 'corpus ACL, citation, prompt-injection and provider assurance', 'contract_filter' => 'spcrc/file16_contract_state', 'criticality' => 'high-risk', 'degraded_behavior' => 'AI actions gated'],
        17 => ['file' => 17, 'name' => 'Communication Network', 'native_owner' => 'relationships, messages, media and calls', 'assurance' => 'identity, IDOR, storage, TURN/SFU and retention assurance', 'contract_filter' => 'spcrc/file17_contract_state', 'criticality' => 'high-risk', 'degraded_behavior' => 'private communications gated'],
        ...
        20 => ['file' => 20, 'name' => 'Unified Application Shell', 'native_owner' => 'global shell, routes and Safe Mode presentation', 'assurance' => 'security-state rendering and reversible repair', 'contract_filter' => 'spcrc/file20_contract_state', 'criticality' => 'critical', 'degraded_behavior' => 'File 24 admin falls back to wp-admin'],
    ...
    {
        return count(self::FILES) === 26 && isset(self::FILES[0], self::FILES[25]);
    }
}
