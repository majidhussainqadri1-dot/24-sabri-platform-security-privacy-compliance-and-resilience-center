...
final class RequirementCatalog
{
    ...
    private const REQUIREMENTS = [
        ...
        'F24-R016' => ['title' => 'Security Contract Interface', 'mode' => 'repository', 'implementation' => 'PlatformIntegrationMatrix, ModuleRegistry, ContractCompatibilityPolicy, File00Adapter, File02Adapter, File20Adapter', 'repository_status' => 'implemented'],
        ...
        'F24-R088' => ['title' => 'Files 00–26 Integration Matrix', 'mode' => 'repository', 'implementation' => 'GovernedArtifactRegistry, RegistryAdmin, Plugin, packaging and integration manifests', 'repository_status' => 'implemented'],
        ...
        'F24-R092' => ['title' => 'Measurable Performance Contract', 'mode' => 'hybrid', 'implementation' => 'PerformanceObjectiveContract, PerformanceMonitor, GovernedArtifactRegistry, ReleaseStatus, CI and external measurements', 'repository_status' => 'implemented'],
        ...
        'F24-R096' => ['title' => 'Current Open Launch Gates and Corrected Historical Blockers', 'mode' => 'hybrid', 'implementation' => 'LaunchBlockerContract, GovernedArtifactRegistry, ReleaseGateManager, SystemCheck, CI and external closure evidence', 'repository_status' => 'implemented'],
