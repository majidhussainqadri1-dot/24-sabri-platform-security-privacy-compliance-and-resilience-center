...
final class File00Adapter
{
    ...
    public function manifest(mixed $manifests): array
    {
        ...
        $manifests[] = [
            ...
            'tables' => ['wordpress-users-and-file00-owned-tables'],
            'files' => ['file00-private-identity-evidence'],
            'secrets' => ['credential-and-step-up-secret-references'],
            'exporters' => ['wordpress-personal-data-exporter'],
            'erasers' => ['wordpress-personal-data-eraser'],
            'emergency_callbacks' => ['identity-suspension-and-step-up-status'],
